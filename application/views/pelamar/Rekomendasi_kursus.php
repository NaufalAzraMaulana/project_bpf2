    ...
    <section id="portfolio" class="portfolio sections-bg">
        <div class="container" data-aos="fade-up">
            ...
            <div class="portfolio-isotope" data-portfolio-filter="*" data-portfolio-layout="masonry" data-portfolio-sort="original-order" data-aos="fade-up" data-aos-delay="100">
                ...
                <?php foreach ($Rekomendasi as $kursuss) : ?>
                    <div class="col-xl-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                            <a href="<?= base_url('Pelamar/detail_kursus/') . $kursuss->id ?>" data-gallery="portfolio-gallery-app" class="glightbox">
                                <img src="<?= base_url('assets/') ?>img/portfolio/app-<?= $kursuss->id ?>.jpg" class="img-fluid" alt="">
                            </a>
                            <div class="portfolio-info">
                                <h4><a href="<?= base_url('Pelamar/detail_kursus/') . $kursuss->id ?>" title="More Details"><?= $kursuss->nama_kursus ?></a></h4>
                                <p><?= $kursuss->bakat_required ?></p>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
